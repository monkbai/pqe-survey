...
\title{Advanced Software Reverse Engineering}  % Title of the thesis.
\author{Z\lowercase{hibo}~LIU}     % Author of the thesis.
...
\department{Computer Science and Engineering}       % Department to which the thesis
                    % is submitted.
\advisor{Prof.~Shuai~WANG}     % Supervisor.
...
\input{chapter/sec-background}
\input{chapter/sec-challenges}
\input{chapter/sec-existing}

\input{chapter/sec-advanced}
\input{chapter/sec-future}
